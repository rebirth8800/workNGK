...
:deep(.ant-pagination) {
  ...
  gap: 10px !important;  /* 👈 Увеличил gap для больших кнопок */
}

:deep(.ant-pagination-item) {
  min-width: 50px !important;   /* 👈 50px */
  height: 50px !important;      /* 👈 50px */
  line-height: 48px !important;
  font-size: 18px !important;   /* 👈 Увеличил шрифт */
...
:deep(.ant-pagination-next .ant-pagination-item-link) {
  font-size: 20px !important;   /* 👈 Увеличил стрелочки */
  color: var(--color-black) !important;
}
